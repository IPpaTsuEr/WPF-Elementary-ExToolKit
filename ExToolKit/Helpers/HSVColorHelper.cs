...
namespace ExToolKit.Helpers
{
    ...
    public class HSVColorHelper
    {
        ...
        public static Color GetAntiColor(Color RGB)
        {
          return GetAntiColor( ConvertToHSV(RGB));
        }

        public static Color GetAntiColor(HSVColor HSV)
        {
            HSVColor _new;
            _new.H = (180 + HSV.H) % 360;
            _new.S = HSV.S;
            _new.V = HSV.S==0? 1 - HSV.V: HSV.V;
            return ConvertToRGB(_new);
        }
